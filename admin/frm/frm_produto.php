<?php
	...
	if($acao !="" ){
		...
		$txt_fabricante			= $dados-> getFabricante();
		$txt_modelo				= $dados-> getModelo();
...
<div id="formulario">
	...
	<form action="./op/op_produto.php" method="post" enctype="multipart/form-data">
		...
		<label>
			...
			<textarea  name="txt_desc" id="txt_desc" cols="84" rows="6"><?php echo $txt_descricao ?> </textarea>
		</label>
		...
		<div class="tres-campos">
			...
			<label>
				...
				<input type="text" name="txt_modelo" id="txt_modelo" value="<?php echo $txt_modelo ?>">
			</label>
			<label>
		...
		<label>
			...
			<textarea  name="txt_conteudo" id="txt_conteudo" cols="84" rows="6"><?php echo $txt_conteudo ?> </textarea>
		</label>
		
		<div class="tres-campos">
			<label>
				<span class="titulo">Fabricante </span>
				<input type="text" name="txt_fabricante" id="txt_fabricante" value="<?php echo $txt_fabricante ?>">
			</label>
			<label>
